...
export const DEFAULT_GALLERY: GalleryItem[] = [
  ...
  // REELS / VIDEOS
  {
    ...
    description: 'Watch the step-by-step royal bridal transformation from skin prep to the final jewelry placement.',
    isFeatured: true,
    mediaType: 'video',
    aspectRatio: 'reel',
    viewCount: '28.4K',
  ...
  },
  {
    ...
    category: 'Reels',
    title: 'HD Airbrush Makeup Process 💄',
  ...
  },
  {
    ...
    category: 'Reels',
    title: 'Floral Gajra Bun Creation 🌸',
    description: 'Creating an intricate bridal low bun with fresh jasmine garlands and handcrafted pearl pins.',
    isFeatured: true,
    mediaType: 'video',
    aspectRatio: 'reel',
    viewCount: '34.1K',
  ...
  },
  {
    ...
    description: 'The secret to crisp, comfortable pallu pleats that stay in place all evening long.',
    isFeatured: true,
    mediaType: 'video',
    aspectRatio: 'reel',
    viewCount: '22.8K',
